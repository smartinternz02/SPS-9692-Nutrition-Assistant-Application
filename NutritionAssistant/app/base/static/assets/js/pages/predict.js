var myClarifaiApiKey = '1300861454de449e96f9a721ef66a808';
var myWolframAppId = 'EQHHY5-35782X69EP';
...
function predict_click(value, source) {
  ...
  reader.addEventListener("load", function () {
    preview.attr('style', 'background-image: url("' + reader.result + '");background-size:contain');
